...
//        //list of organizations
        periods.add(new Organization.Period(LocalDate.of(1999, 10, 10), LocalDate.now(),  "Автор проекта", "Создание, организация и проведение Java онлайн проектов и стажировок."));
...
//        periodsOfEducation.add(new Organization.Period("Закончил с отличием", 1984, Month.of(9), 1987, Month.of(6), ""));
        periodsOfEducation.add(new Organization.Period( LocalDate.of(1999, 10, 10),LocalDate.of(2022, 12, 12), "Закончил с отличием", ""));
        ...
        organizationsOfEducation.add(new Organization("МФТИ", "school.mipt.ru",
                new ArrayList<>(Collections.singleton(new Organization.Period( LocalDate.of(1999, 10, 10), LocalDate.of(2000, 6, 12),"\n Закончил с отличием", "")))));
